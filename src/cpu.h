...
namespace riscv {
    struct cpu {
        ...
        dword_t  ID_EX_r1, ID_EX_r2, ID_EX_imm, ID_EX_rd, ID_EX_pc;
        inst::inst_t ID_EX_op,EX_MEM_op,MEM_INNER_op,MEM_WB_op,EX_op,MEM_op,WB_op;
        dword_t  EX_MEM_output, EX_MEM_rd, EX_MEM_r2;
        dword_t MEM_INNER_rd,MEM_INNER_r2,MEM_ACCESS_counter=0;
        dword_t MEM_WB_output, MEM_WB_rd;
        dword_t  ID_inst,ID_pc;
        dword_t  EX_r1, EX_r2, EX_imm, EX_rd, EX_pc;
        dword_t  MEM_value, MEM_rd, MEM_r2;
